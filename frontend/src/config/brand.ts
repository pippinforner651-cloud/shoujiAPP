...
export const BRAND = {
  ...
  /* ======= 称号系统 ======= */
  TITLES: [
    { name: '戈壁初心者', desc: '加入E23跑起来，共同开启新的旅程。', minKm: 0 },
    ...
    { name: '世界奔跑者', desc: '累计跑步达到10000公里。', minKm: 10000 },
  ],

  /* ======= 勋章系统 ======= */
  BADGES: [
    { name: '首次出发', desc: '完成第一次跑步记录。', icon: '🎯' },
    { name: '戈壁起点', desc: '加入E23跑起来，共同开启新的旅程。', icon: '🏜️' },
    { name: '十公里跑者', desc: '累计跑步达到10公里。', icon: '🏅' },
    { name: '百里跑者', desc: '累计跑步达到100公里。', icon: '🥈' },
    { name: '连续七天', desc: '连续7天完成运动记录。', icon: '📅' },
    { name: '城市探索者', desc: '与E23共同到达第一个新城市。', icon: '🏙️' },
    { name: '环游同行者', desc: '参与推动团队完成一段重要旅程。', icon: '🗺️' },
    { name: '戈壁精神', desc: '在困难中坚持，在团队中前行。', icon: '🔥' },
    { name: '世界奔跑者', desc: '参与E23世界地图环游计划。', icon: '🌍' },
  ],
  ...
  SHARE: {
    ...
    totalMileage: '累计里程',
    teamReached: '团队当前到达',
    footer: '每一步，都在推动E23向前。',
    footerAlt: '一个人跑得快，一群人跑得远。',
    footerAlt2: '始于戈壁，不止于远方。',
  },
